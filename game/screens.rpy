...
screen say(who, what):
    ...
    window:
        ...
        add Text(nwhat, slow=True, style="say_dialogue")
...
screen choice(items):
    ...
    python:
        randomitems = items[:]
        renpy.random.shuffle(randomitems)
...
screen calendar(day):
    ...
    imagebutton:
        ...
        hover Transform(f"calendar/calendar_day{day}.jpg", fit="contain")
        action [ With("fade"), Return() ]

# Top-right UI

transform ui_triangle:
    xalign 1.0 yalign 0

transform ui_daylabel:
    xalign 0.98 yalign 0.02

transform ui_timeday:
    xalign 0.98 yalign 0.07

screen top_right_ui(day, time):
    add Triangle() at ui_triangle
